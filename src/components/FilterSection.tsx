...
import type { Genre, Language } from '@/types/tmdb';
        ...
        <div className='mb-6'>
          ...
          <div className='relative'>
            ...
            <input
              ...
              className='w-full pl-10 pr-4 py-2 bg-[#252B37] text-sm text-gray-300 placeholder-gray-400 rounded-2xl border border-white/10 focus:outline-none focus:border-white/30'
            />
          </div>
        </div>

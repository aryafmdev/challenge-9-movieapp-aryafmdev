...
export default function Card({ media }: { media: TMDBItem }) {
  ...
  return (
    <div className='flex-none w-44 md:w-52 lg:w-56 xl:w-60 min-w-[176px] max-w-[240px] rounded-lg overflow-hidden shadow-lg snap-start'>
      <Link href={`/details?id=${id}&media_type=${mediaType}`}>
        <div className='relative aspect-[2/3] group cursor-pointer'>
          <Image
            ...
            alt={displayTitle}
            fill
            className='object-cover rounded-xl transition-all group-hover:brightness-95'
